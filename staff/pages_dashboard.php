...
//return total number of BANK clients
...
//return total number of BANK Staffs
...
//return total number of BANK Account Types
...
//return total number of BANK Deposits
...
//return total number of BANK Withdrawals
...
//return total number of BANK Transfers
...
//return total number of  BANK initial cash->balances
            ...
            <div class="col-12 col-sm-6 col-md-3">
              <div class="info-box mb-3">
                ...
                <div class="info-box-content">
                  ...
                  <span class="info-box-number">RP <?php echo $iB_withdrawal; ?> </span>
                </div>
              </div>
            </div>
            <!-- Withdrawals-->
            ...
            <div class="col-12 col-sm-6 col-md-3">
              <div class="info-box mb-3">
                ...
                <div class="info-box-content">
                  ...
                  <span class="info-box-number">RP <?php echo $iB_Transfers; ?></span>
                </div>
              </div>
            </div>
            <!-- /.Transfers-->
            ...
            <div class="col-12 col-sm-6 col-md-3">
              <div class="info-box mb-3">
                ...
                <div class="info-box-content">
                  ...
                  <span class="info-box-number">RP <?php echo $TotalBalInAccount; ?></span>
                </div>
              </div>
            </div>
            <!-- ./Balances-->
                  ...
                  <div class="row">
                    <div class="col-sm-3 col-6">
                      <div class="description-block border-right">
                        <h5 class="description-header">RP <?php echo $iB_deposits; ?></h5>
                    ...
                    <div class="col-sm-3 col-6">
                      <div class="description-block border-right">
                        <h5 class="description-header">RP <?php echo $iB_withdrawal; ?></h5>
                    ...
                    <div class="col-sm-3 col-6">
                      <div class="description-block border-right">
                        <h5 class="description-header">RP <?php echo $iB_Transfers; ?> </h5>
                    ...
                    <div class="col-sm-3 col-6">
                      <div class="description-block">
                        <h5 class="description-header">RP <?php echo $TotalBalInAccount; ?> </h5>
                      ...
                      <tbody>
                        ...
                        ?>
                          <tr>
                            ...
                            <td>RP <?php echo $row->transaction_amt; ?></td>
